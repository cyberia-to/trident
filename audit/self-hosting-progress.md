...
- [ ] SH3 function attributes/purity/contracts, then true imports and complete
  compiler closure coverage; [implementation order](../.claude/plans/native-assertions.md).
