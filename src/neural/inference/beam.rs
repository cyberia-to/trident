...
//! applying grammar masks at each step to enforce target assembly validity.
...
pub fn beam_search<B: Backend>(
    ...
    for step in 0..config.max_steps {
        ...
        for b in 0..k {
            ...
            let mut sm = target.grammar(initial_stack_depth);
            ...
            let mut sm2 = target.grammar(initial_stack_depth);
        ...
        for b in 0..k {
            ...
            let mut recent = vec![false; vocab_size];
