...
pub(super) fn extract_data_deps(nodes: &[TirNode], edges: &mut Vec<(usize, usize, EdgeKind)>) {
...
pub(super) fn extract_mem_order(nodes: &[TirNode], edges: &mut Vec<(usize, usize, EdgeKind)>) {
