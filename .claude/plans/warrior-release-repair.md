...
- Final evidence, local candidate artifacts and exact remaining gates: reference/warrior-release-validation.md. Protocol redesign and live deployment are not complete.
